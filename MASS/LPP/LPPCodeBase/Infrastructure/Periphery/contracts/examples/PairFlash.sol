...
/// @notice An example contract using the flash function
contract PairFlash is ILPPFlashCallback, PeripheryPayments {
    ...
    /// @notice Calls the pools flash function with data needed in `lppFlashCallback`
