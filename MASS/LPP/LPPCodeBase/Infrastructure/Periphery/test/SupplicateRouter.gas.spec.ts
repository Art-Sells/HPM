...
import { IWETH9, MockTimeSupplicateRouter, TestERC20 } from '../typechain-types/periphery'
import { ILPPPool } from '../typechain-types/protocol'
...
describe('SupplicateRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, ILPPPoolABI, wallet)) as [
      ILPPPool,
      ILPPPool,
      ILPPPool
    ]
