...
/// @title Callback for ILPPPoolActions#mint
/// @notice Any contract that calls ILPPPoolActions#mint must implement this interface
interface ILPPMintCallback {
    ...
    /// @param data Any data passed through by the caller via the ILPPPoolActions#mint call
