...
async function deploySystem() {
  ...
  const Vesting  = await ethers.getContractFactory("LPPVesting");
...
describe("Callback / reentrancy safety", () => {
   ...
   *───────────────────────────────────────────────────────────────────────────*/
  it("LPPVesting: reentrancy during payout does not overpay", async () => {
   ...
   *───────────────────────────────────────────────────────────────────────────*/
  it("LPPPool: reentrancy during payout transfer cannot drain reserves", async () => {
   ...
   *───────────────────────────────────────────────────────────────────────────*/
  it("LPPMintHook: reentrancy during mintWithRebate token pulls cannot drain pool/treasury", async () => {
    ...
    // Call hook
    await (await (await ethers.getContractAt("LPPMintHook", await hook.getAddress()))
      .connect(user)
      .mintWithRebate({
        pool: poolAddr,
        to: user.address,
